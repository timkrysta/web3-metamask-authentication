<style>
    #initializing_metamask_modal {
        display: none;
    }
</style>
<div class="modal fade  modal-dialog modal-dialog-centered" id="initializing_metamask_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="initializing_metamask_label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="initializing_metamask_label"></h5>
                <button
                    type="button"
                    class="btn-close"
            ...
            <div class="modal-body">
                <div class="radius_plus_padding" style="border: 1px solid black;">
                    <div class="spinner-border text-primary center_verticaly" role="status" style="width: 1.5rem; height: 1.5rem;">
                        <span class="visually-hidden">Loading...</span>
                    </div>
                    <div class="center_verticaly" style="margin-left:0.5rem;">Initializing...</div>
                </div>
                <div class="py-3"></div>

                <div class="radius_plus_padding" style="background-color:#f6f6f6;">
                    <div>
                        <b>MetaMask</b>
                    </div>
                    <div class="center_verticaly">
                        If MetaMask extension has not appeared, click
                        <br>
                        icon in your browser
                    </div>
                    <div class="center_verticaly" style="margin-left:.5rem;">
